    ...
    <div class="bg-white min-h-screen">
        <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="text-center mb-12" style="opacity: 1; transform: none;">
                ...
                <p class="text-xl sm:text-2xl text-[#86868b] max-w-3xl mx-auto">Locate GPs, sports medicine clinics, and hospitals near you for concussion
                    assessment and care.
                </p>
            </BlurReveal>
            </div>
            <div class="bg-gradient-to-br from-[#ff3b30] to-[#ff2d55] rounded-3xl p-8 mb-12 shadow-2xl shadow-red-500/20" style="opacity: 1; transform: none;">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-white/95 text-lg mb-4 leading-relaxed">If you or someone you know is experiencing severe headache,
            ...
            <div class="bg-[#f5f5f7] rounded-3xl p-8 mb-12 shadow-lg" style="opacity: 1; transform: none;">
                <div class="flex items-center gap-3 mb-6">
                    <div class="bg-[#007aff] rounded-2xl p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search text-white"
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <div class="flex-1">
                        <input type="text" placeholder="Enter your suburb or postcode..." v-model="userInput" @keyup="() => fetchPredictions()"
                            class="w-full bg-white border-2 border-[#d2d2d7] rounded-2xl px-6 py-4 text-[#1d1d1f] text-lg focus:outline-none focus:border-[#007aff] transition-colors" value="">   
                        <div v-if="fetchedPredictions" class="relative">
                             <ul class="absolute top-0 z-2! min-w-[300px] lg:min-w-[600px] h-[200px] shadow-2xl p-6 bg-white overflow-y-auto">
                                <li v-for="prediction in fetchedPredictions" :key="prediction.description" class="pt-2 pb-4 border-b-1 hover:bg-gray-100">{{ prediction?.description }}</li>
                            </ul>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div class="bg-white rounded-3xl overflow-hidden shadow-2xl shadow-black/5 border border-[#d2d2d7]/50" style="opacity: 1; transform: none;">
                    <div class="bg-[#f5f5f7] p-6 border-b border-[#d2d2d7]/50">
                        <h3 class="text-xl font-semibold text-[#1d1d1f] flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-map-pin text-[#007aff]">
                                <path
                                    d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0">
                                </path>
                                <circle cx="12" cy="10" r="3"></circle>
                            </svg>Nearby Providers</h3>
                    </div>
            ...
            <div class="mt-12 bg-linear-to-br from-[#007aff]/10 to-[#5ac8fa]/10 rounded-3xl p-8 border border-[#007aff]/30" style="opacity: 1; transform: none;">
